...
typedef struct TableAssignFullDbs_ {
    ...
    struct TableAssignFullDbs_ * I1241;
    struct TableAssignFullDbs_ * I1242;
...
typedef struct TableAssignLayoutOnClk_ {
    ...
    U  I841 :9;
    RP  ptable;
    RmaSeqPrimOutputOnClkS  I1246;
    RmaEblk  I661;
} TableAssignLayoutOnClk;
typedef struct TableAssignLayoutOnClkFullDbs_ {
    struct TableAssignLayoutOnClkFullDbs_ * I988;
    struct TableAssignLayoutOnClkFullDbs_ * I1241;
    struct TableAssignLayoutOnClkFullDbs_ * I1242;
...
typedef struct TableAssignLayoutOnClkOpt_ {
    ...
    RmaSeqPrimOutputOnClkOpt  I1246;
    RmaSeqPrimOutputEblkData  I1252;
} TableAssignLayoutOnClkOpt;
typedef struct TableAssignLayoutOnClkOptFullDbs_ {
    struct TableAssignLayoutOnClkOptFullDbs_ * I988;
    struct TableAssignLayoutOnClkOptFullDbs_ * I1241;
    struct TableAssignLayoutOnClkOptFullDbs_ * I1242;
...
struct dummyq_struct {
    ...
    struct futq * I1375;
    struct futq * I1376;
    struct sched_table * I1377;
    struct futq_info * I1379;
    ...
    EBLK  * I1438;
    int I1439;
    struct vcs_globals_t * I1440;
    clock_struct  I1442;
    unsigned long long I1443;
    EBLK  * I1444;
    EBLK  * I1445;
    void * I1446;
...
extern "C" {
#endif
void  rmaPropagate0_p_arbiter_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_arbiter_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_f_arbiter_simv_daidir (UB  * pcode, scalar  val, U  I612, scalar  * I1502, U  did);
void  rmaPropagate0_r_arbiter_simv_daidir (UB  * pcode);
void  rmaPropagate0_wn_arbiter_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_p_arbiter_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_arbiter_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_f_arbiter_simv_daidir (UB  * pcode, scalar  val, U  I612, scalar  * I1502, U  did);
void  rmaPropagate1_r_arbiter_simv_daidir (UB  * pcode);
void  rmaPropagate1_wn_arbiter_simv_daidir (UB  * pcode, scalar  val);
